...
Item { id: root_
  ...
  property color tengxunColor: settings_.tengxunColor
  property color caiyunColor: settings_.caiyunColor
  property color mojiColor: settings_.mojiColor
  ...
  function translatorColor(host) { // string -> color
    ...
    case 'tengxun': return root_.tengxunColor
    case 'caiyun': return root_.caiyunColor
    case 'moji': return root_.mojiColor
    default:
      if (host) {
        var i = host.indexOf(',')
        if (i !== -1)
