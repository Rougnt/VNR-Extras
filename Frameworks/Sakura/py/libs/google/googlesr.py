...
# See: https://www.google.cn/intl/ja/chrome/demos/speech.html
...
#def defaultapi(): return 'http://translate.google.cn/m' # this will redirect to https
def defaultapi(): return "http://www.google.cn/speech-api/v2/recognize"
def setapi(url):
  """
  @param  url  str
  """
...
# Example: "http://www.google.cn/speech-api/v2/recognize?client=chromium&lang=%s&key=%s" % (self.language, self.key)
