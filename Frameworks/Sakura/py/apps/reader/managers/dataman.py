...
class _Term(object):
  ...
  HOSTS = 'bing', 'google', 'babylon', 'lecol', 'infoseek', 'excite', 'nifty', 'systran', 'transru', 'naver', 'baidu', 'youdao', 'tengxun', 'caiyun', 'moji', 'jbeijing', 'fastait', 'dreye', 'eztrans', 'transcat', 'lec', 'atlas', 'hanviet', 'vtrans'
