...
class _MainObject(object):
  ...
  def translatorManager(self):
    ...
    ret.setTengxunEnabled(ss.isTengxunEnabled())
    ss.tengxunEnabledChanged.connect(ret.setTengxunEnabled)

    ret.setCaiyunEnabled(ss.isCaiyunEnabled())
    ss.caiyunEnabledChanged.connect(ret.setCaiyunEnabled)

    ret.setMojiEnabled(ss.isMojiAPIEnabled())
    ss.mojiAPIEnabledChanged.connect(ret.setMojiEnabled)
