...
class Settings(QSettings):
  ...
  tengxunColorChanged = Signal(str)
  def tengxunColor(self):
    return self.value('TengxunColor', config.SETTINGS_TENGXUN_COLOR)
  def setTengxunColor(self, value):
    value = value or config.SETTINGS_TENGXUN_COLOR
    if value != self.tengxunColor():
      self.setValue('TengxunColor', value)
      self.tengxunColorChanged.emit(value)

  caiyunColorChanged = Signal(str)
  def caiyunColor(self):
    return self.value('CaiyunColor', config.SETTINGS_CAIYUN_COLOR)
  def setCaiyunColor(self, value):
    value = value or config.SETTINGS_CAIYUN_COLOR
    if value != self.caiyunColor():
      self.setValue('CaiyunColor', value)
      self.caiyunColorChanged.emit(value)

  mojiColorChanged = Signal(str)
  def mojiColor(self):
    return self.value('MojiColor', config.SETTINGS_MOJI_COLOR)
  def setMojiColor(self, value):
    value = value or config.SETTINGS_MOJI_COLOR
    if value != self.mojiColor():
      self.setValue('MojiColor', value)
      self.mojiColorChanged.emit(value)
  ...
  baiduAPIEnabledChanged = Signal(bool)
  def isBaiduAPIEnabled(self):
    return to_bool(self.value('BaiduAPIEnabled'))
  def setBaiduAPIEnabled(self, value):
    if value != self.isBaiduAPIEnabled():
      self.setValue('BaiduAPIEnabled', value)
      self.baiduAPIEnabledChanged.emit(value)

  baiduAppIDChanged = Signal(str)
  def getBaiduAppID(self):
    return self.value('BaiduAppID')
  def setBaiduAppID(self, value):
    if value != self.getBaiduAppID():
      self.setValue('BaiduAppID', value)
      self.baiduAppIDChanged.emit(value)

  baiduKeyChanged = Signal(str)
  def getBaiduKey(self):
    return self.value('BaiduKey')
  def setBaiduKey(self, value):
    if value != self.getBaiduKey():
      self.setValue('BaiduKey', value)
      self.baiduKeyChanged.emit(value)
  ...
  tengxunEnabledChanged = Signal(bool)
  def isTengxunEnabled(self):
    return to_bool(self.value('TengxunEnabled'))
  def setTengxunEnabled(self, value):
    if value != self.isTengxunEnabled():
      self.setValue('TengxunEnabled', value)
      self.tengxunEnabledChanged.emit(value)

  tengxunAPIEnabledChanged = Signal(bool)
  def isTengxunAPIEnabled(self):
    return to_bool(self.value('TengxunAPIEnabled'))
  def setTengxunAPIEnabled(self, value):
    if value != self.isTengxunAPIEnabled():
      self.setValue('TengxunAPIEnabled', value)
      self.tengxunAPIEnabledChanged.emit(value)

  tengxunAppIDChanged = Signal(str)
  def getTengxunAppID(self):
    return self.value('TengxunAppID')
  def setTengxunAppID(self, value):
    if value != self.getTengxunAppID():
      self.setValue('TengxunAppID', value)
      self.tengxunAppIDChanged.emit(value)

  tengxunKeyChanged = Signal(str)
  def getTengxunKey(self):
    return self.value('TengxunKey')
  def setTengxunKey(self, value):
    if value != self.getTengxunKey():
      self.setValue('TengxunKey', value)
      self.tengxunKeyChanged.emit(value)

  caiyunEnabledChanged = Signal(bool)
  def isCaiyunEnabled(self):
    return to_bool(self.value('CaiyunEnabled'))
  def setCaiyunEnabled(self, value):
    if value != self.isCaiyunEnabled():
      self.setValue('CaiyunEnabled', value)
      self.caiyunEnabledChanged.emit(value)

  caiyunAPIEnabledChanged = Signal(bool)
  def isCaiyunAPIEnabled(self):
    return to_bool(self.value('CaiyunAPIEnabled'))
  def setCaiyunAPIEnabled(self, value):
    if value != self.isCaiyunAPIEnabled():
      self.setValue('CaiyunAPIEnabled', value)
      self.caiyunAPIEnabledChanged.emit(value)

  caiyunTokenChanged = Signal(str)
  def getCaiyunToken(self):
    return self.value('CaiyunToken')
  def setCaiyunToken(self, value):
    if value != self.getCaiyunToken():
      self.setValue('CaiyunToken', value)
      self.caiyunTokenChanged.emit(value)

  xuniEnabledChanged = Signal(bool)
  def isXuniEnabled(self):
    return to_bool(self.value('XuniEnabled'))
  def setXuniEnabled(self, value):
    if value != self.isXuniEnabled():
      self.setValue('XuniEnabled', value)
      self.xuniEnabledChanged.emit(value)

  mojiAPIEnabledChanged = Signal(bool)
  def isMojiAPIEnabled(self):
    return to_bool(self.value('MojiAPIEnabled'))
  def setMojiAPIEnabled(self, value):
    if value != self.isMojiAPIEnabled():
      self.setValue('MojiAPIEnabled', value)
      self.mojiAPIEnabledChanged.emit(value)

  mojiIDChanged = Signal(str)
  def getMojiID(self):
    return self.value('MojiID')
  def setMojiID(self, value):
    if value != self.getMojiID():
      self.setValue('MojiID', value)
      self.MojiIDChanged.emit(value)

  mojiTokenChanged = Signal(str)
  def getMojiToken(self):
    return self.value('MojiToken')
  def setMojiToken(self, value):
    if value != self.getMojiToken():
      self.setValue('MojiToken', value)
      self.mojiTokenChanged.emit(value)
...
class SettingsProxy(QObject):
  ...
  def __init__(self, parent=None):
    ...
    g.tengxunColorChanged.connect(self.tengxunColorChanged)
    g.caiyunColorChanged.connect(self.caiyunColorChanged)
    g.mojiColorChanged.connect(self.mojiColorChanged)
  ...
  tengxunColorChanged = Signal(unicode)
  tengxunColor = unicode_property('TengxunColor', config.SETTINGS_TENGXUN_COLOR, notify=tengxunColorChanged)
  caiyunColorChanged = Signal(unicode)
  caiyunColor = unicode_property('CaiyunColor', config.SETTINGS_CAIYUN_COLOR, notify=caiyunColorChanged)
  mojiColorChanged = Signal(unicode)
  mojiColor = unicode_property('MojiColor', config.SETTINGS_MOJI_COLOR, notify=mojiColorChanged)
